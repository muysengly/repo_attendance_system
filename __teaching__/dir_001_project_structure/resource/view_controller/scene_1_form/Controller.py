...
class Window(Ui_MainWindow, QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Scene #1 Form")
...
def f_click():
    win.close()
    os.system(f"python {path_depth}resource/view_controller/scene_2_form/Controller.py")  

win.pushButton.clicked.connect(f_click)
